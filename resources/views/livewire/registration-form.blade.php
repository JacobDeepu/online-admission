            ...
            <div class="grid gap-2 sm:grid-cols-2" x-show="currentTab === 3">
                <div class="rounded border border-sky-400 p-2">
                    <div class="grid gap-2 sm:grid-cols-2">
                        ...
                        <div class="mt-0">
                            <x-input-float-label class="block w-full" name="father_annual_income" type="text" wire:model.blur="father_annual_income" label="{{ __('Annual Income') }}" required
                                autofocus />
                        </div>
                        <div class="mt-0">
                        ...
                        <div class="mt-0">
                            <x-input-float-label class="block w-full" name="father_office_number" type="text" wire:model.blur="father_office_number" label="{{ __('Office Number') }}" required
                                autofocus />
                        </div>
                        <div class="mt-0">
                ...
                <div class="rounded border border-sky-400 p-2">
                    <div class="grid gap-2 sm:grid-cols-2">
                        ...
                        <div class="mt-0">
                            <x-input-float-label class="block w-full" name="mother_occupation" type="text" wire:model.blur="mother_occupation" label="{{ __('Occupation') }}" required
                                autofocus />
                        </div>
                        <div class="mt-0">
